...
CREATE USER user_relatorio;
CREATE ROLE role_relatorio;
GRANT SELECT ON uc4atividades TO role_relatorio;
REVOKE SELECT ON uc4atividades FROM role_relatorio;
...
CREATE USER user_funcionario;
CREATE ROLE role_funcionario;
GRANT SELECT, INSERT, UPDATE, DELETE ON venda TO role_funcionario;
GRANT SELECT, INSERT, UPDATE, DELETE ON cliente TO role_funcionario;
GRANT SELECT, INSERT, UPDATE, DELETE ON produto TO role_funcionario;
