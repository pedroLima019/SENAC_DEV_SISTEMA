...
GRANT SELECT ON nome_banco.nome_tabela TO 'nome_usuario'@'localhost';
CREATE ROLE 'select';
GRANT SELECT ON nome_banco.nome_tabela TO 'nome_papel';
GRANT 'select' TO 'nome_usuario'@'localhost';
